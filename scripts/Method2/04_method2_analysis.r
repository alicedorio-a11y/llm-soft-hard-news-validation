############################################################
# Reliability analysis and performance metrics
############################################################
...
############################################################
# File paths and output structure
############################################################

INPUT_FILE <- "/Users/alice.dorio/Desktop/data/codifiche_completate/METODO2_contenuto/CODIFICA/Codifca_senzacontenutoesplicito_peranalisi.xlsx"
OUT_DIR    <- "/Users/alice.dorio/Desktop/data/codifiche_completate/METODO2_contenuto/ANALISI"

if (!dir.exists(OUT_DIR)) dir.create(OUT_DIR, recursive = TRUE, showWarnings = FALSE)

OUT_XLSX <- file.path(OUT_DIR, "analisi_affidabilita_metriche_content.xlsx")
OUT_CSV  <- file.path(OUT_DIR, "analisi_affidabilita_metriche_content.csv")
OUT_PDF  <- file.path(OUT_DIR, "analisi_metriche_summary_content.pdf")
OUT_PNG  <- file.path(OUT_DIR, "analisi_metriche_summary_content.png")
IC_PDF   <- file.path(OUT_DIR, "inter_coder_reliability_content.pdf")
IC_PNG   <- file.path(OUT_DIR, "inter_coder_reliability_content.png")

############################################################
# Variable definition and measurement level
############################################################
...
############################################################
# Utility functions for robustness
############################################################
...
############################################################
# Inter-coder reliability summary plots
############################################################
...
############################################################
# Summary plots of reliability metrics
############################################################
