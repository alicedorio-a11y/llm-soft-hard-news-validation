...
call_gpt_con_100parole <- function(testo_articolo) {
  ...
  prompt <- paste0(
    ...
    "Ti fornisco SOLO le prime ~100 parole di un articolo. ",
    "Devi comunque codificare secondo il codebook.\n\n",
    ...
    "}\n\n",
    "IMPORTANTE: rispondi SOLO con il JSON.\n\n",
    "TESTO (prime 100 parole):\n",
    testo_articolo, "\n"
  )
